...
const ICONS = {
  ...
  redo: () => [
    P('m15 14 5-5-5-5', 'a'),
    P('M20 9H9.5a5.5 5.5 0 0 0 0 11H13', 'b'),
  ],
  /* ── จัดข้อความ / จัดวาง (แถบเครื่องมือหน้าออกแบบการ์ด) ── */
  alignLeft:   () => [P('M4 6h16M4 12h10M4 18h13', 'a')],
  alignCenter: () => [P('M4 6h16M7 12h10M5.5 18h13', 'a')],
  alignRight:  () => [P('M4 6h16M10 12h10M7 18h13', 'a')],
  /* จัดกึ่งกลางแนวนอนของทั้งหน้า — เส้นประกลางหน้า + กล่องคร่อม */
  centerPage: () => [
    P('M12 2v20', 'a'),
    <rect key="b" x="6" y="7" width="12" height="10" rx="1.5" />,
  ],
  text: () => [P('M4 6V4h16v2M12 4v16M9 20h6', 'a')],
